...
<div class="contenedor1">
    <button id="btn1-abrir1-popup1"
        class="btn1-abrir1-popup1 btn1 bg-cyan-600 rounded-full text-white text-3xl p-3 item-center  hover:bg-sky-700 ">Contáctanos</button>
    <div class="overlay1 z-50" id="overlay1">
        <div class="popup1 absolute " id="popup1"
            ...
            <div class="contenedor1-acordeon1">
                ...
                {{-- lo hizo Enrique --}}
                {{-- <div class="acordeon1">
                    <label for="btn1-acordeon11">
                        <a href="mailto:imco@gmail.com" target="_blank">
                            <i class="far fa-envelope"></i>
                            imco@gmail.com
                        </a>
                    </label>
                    <label for="btn1-acordeon11">
                        <a href="https://www.facebook.com/GrupoImcoDigital/" target="_blank">
                            <i class="fab fa-facebook"></i>
                            imco
                        </a>
                    </label>
                    <label for="btn1-acordeon11">
                        <a href="https://www.instagram.com/imco.digital/" target="_blank">
