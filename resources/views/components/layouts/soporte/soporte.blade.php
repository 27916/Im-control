...
<div class="contenedor">
    <!--<button id="btn-abrir-popup" class="btn-abrir-popup btn btn-primary" style="background-color: rgb(22 78 99);; width: 8%; border: radious 10px;;" >Ayuda y soporte</button>
        <a id="btn-abrir-popup" class="btn-abrir-popup btn"><img src="{{ asset('images/ImControl/spt.png') }}" alt=""></a>-->
    <button id="btn-abrir-popup"
        class="btn-abrir-popup btn bg-[#152a3a] rounded-full text-white text-2xl p-3 item-center  hover:bg-cyan-900 ">Ayuda
        & Soporte</button>
