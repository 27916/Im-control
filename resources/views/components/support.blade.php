...
<div class="contenedor">
    ...
    <button id="btn-abrir-popup"
        class="btn-abrir-popup btn1 bg-cyan-600 rounded-full text-white text-3xl p-3 item-center w-[100%] hover:bg-sky-700 ">Ayuda
        y soporte</button>
                ...
                <div class="acordeon">
                    ...
                    <div class="contenido-acordeon">
                        <p>Las campañas se encuentran en cada categoría de red social.
                            Pará acceder a las canpañas da clic en el icono de la red social de la cual quieres
                ...
                <div class="acordeon">
                    ...
                    <div class="contenido-acordeon">
                        <p> Los reportes sólo se pueden generar de las campañas activas.
                            Puedes generar un reporte cuando das clic en el icono “generar reporte” que está debajo de
