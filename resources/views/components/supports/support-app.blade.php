...
<div class="contenedor">
    ...
    <button id="btn-abrir-popup" class="btn-abrir-popup btn bg-[#152a3a] rounded-full text-white text-2xl p-3 item-center  hover:bg-cyan-900 ">Ayuda y soporte</button>
