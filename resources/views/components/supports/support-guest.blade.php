...
<div class="contenedor">
    <!--<button id="btn-abrir-popup" class="btn-abrir-popup btn btn-primary" style="background-color: rgb(22 78 99);; width: 8%; border: radious 10px;;" >Ayuda y soporte</button>
        <a id="btn-abrir-popup" class="btn-abrir-popup btn bg-cyan-600 rounded-full text-white text-3xl p-3 item-center  hover:bg-sky-700  w-[30%]">Ayuda y soporte</a>-->
    <button id="btn-abrir-popup"
        class="btn-abrir-popup btn bg-cyan-600 rounded-full text-white text-3xl p-3 item-center  hover:bg-sky-700">Ayuda
        & Soporte</button>
    <div class="overlay z-50" id="overlay">
        <div class="popup absolute" id="popup"
            style="font-family: 'Manrope',serif; background-image:url(https://im-control.com/main/public/images/ImControl/window.png);">
            <a href="#" id="btn-cerrar-popup" class="btn-cerrar-popup"><i class="fas fa-times"></i></a>
            <div class="contenedor-acordeon">
                <h2>¡Hola!</h2>
                <p>¿Tienes dudas sobre la app? <br> Da click en una pregunta frecuente y descubre la información.</p>
                <div class="acordeon">
                    ...
                    <div class="contenido-acordeon">
                        <p>Las campañas se encuentran en cada categoría de red social.
                            Para acceder a las campañas da click en el icono de la red social de la cual quieres
                            visualizar las campañas.</p>
                    </div>
                </div>
                <div class="acordeon">
                    <input type="radio" name="acordeon" id="btn-acordeon2" class="btn-acordeon">
                    <label for="btn-acordeon2">
                        ¿Cómo se cuál campaña está activa o caducada?
                    </label>
                    <div class="contenido-acordeon">
                ...
                <div class="acordeon">
                    ...
                    <div class="contenido-acordeon">
                        <p> Las campañas con estatus caducada tienen información del periodo de tiempo en el que
                            estuvieron activas.
                ...
                <div class="acordeon">
                    ...
                    <div class="contenido-acordeon">
                        <p> Los reportes sólo se pueden generar de las campañas activas.
                            Puedes generar un reporte cuando das click en el icono “generar reporte” que está debajo de
                            la información de la campaña activa.
                            Se mostrará el mensaje "el reporte se envió al correo electrónico".</p>
                    </div>
                </div>
                <div class="acordeon">
...
<div class="contenedor">
    <!--<button id="btn-abrir-popup" class="btn-abrir-popup btn btn-primary" style="background-color: rgb(22 78 99);; width: 8%; border: radious 10px;;" >Ayuda y soporte</button>
    <a id="btn-abrir-popup" class="btn-abrir-popup btn bg-cyan-600 rounded-full text-white text-3xl p-3 item-center  hover:bg-sky-700  w-[30%]">Ayuda y soporte</a>-->
    <button id="btn-abrir-popup" class="btn-abrir-popup btn1 bg-cyan-600 rounded-full text-white text-3xl p-3 item-center w-[100%] hover:bg-sky-700 ">Ayuda y soporte</button>
    <div class="overlay z-50" id="overlay">
        <div class="popup absolute" id="popup" style="font-family: 'Manrope',serif; background-image:url(https://im-control.com//main/public/images/ImControl/window.png);" >
            <a href="#" id="btn-cerrar-popup" class="btn-cerrar-popup"><i class="fas fa-times"></i></a>
            <div class="contenedor-acordeon1 py-8">
                <h2>¡Hola!</h2>
